...
public class SplashFragment_3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.splash_fragment_3, container, false);
        splash_skip = mView.findViewById(R.id.splash_skip);
        splash_skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.splash_fragment_3,new SplashFragment_5()).addToBackStack(null).commit();
            }
        });
